...
/**
 * Provides a collection of localizable property values for a JavaFX {@link javafx.scene.control.ComboBox},
 * extending {@link ControlPropertyBundle} with prompt text and item values properties.
 */
public class ComboBoxPropertyBundle extends ControlPropertyBundle
{
    /** Creates a new ComboBoxPropertyBundle. */
    public ComboBoxPropertyBundle()
    {
    }

    /**
     * A key for the prompt text of the ComboBox.
     */
    public static final String PROMPT_TEXT = "PromptText";

    /**
     * A key for the string array of item values for the ComboBox.
     */
    public static final String VALUES = "Values";

    private static final Set<String> OWN_ATTRIBUTE_NAMES = Set.of(PROMPT_TEXT, VALUES);
    ...
    /**
     * Returns the set of valid attribute names for a ComboBoxPropertyBundle.
     *
     * @return The set of valid attribute names for a ComboBoxPropertyBundle.
     */
    @Override
