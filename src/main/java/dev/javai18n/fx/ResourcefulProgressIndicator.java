...
/**
 * A ProgressIndicator that supports localizing the name (id), style, tooltip,
 * accessible text, accessible help, and accessible role description.
 */
public class ResourcefulProgressIndicator extends ProgressIndicator implements Resourceful, LocaleEventListener
{
    static
    {
    ...
    /**
     * Construct a ResourcefulProgressIndicator with the specified Resource.
     * @param resource A Resource containing a ControlPropertyBundle.
     * @return A ResourcefulProgressIndicator with updated Locale-specific values that is registered
     *         to listen to LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulProgressIndicator create(Resource resource)
    {
        ResourcefulProgressIndicator progressIndicator = new ResourcefulProgressIndicator(resource);
    ...
    /**
     * Constructs a ProgressIndicator bound to the given resource. Use {@link #create(Resource)}
     * for an initialized instance.
     * @param resource The resource identifying the locale source and bundle key.
     */
    protected ResourcefulProgressIndicator(Resource resource)
    {
     ...
     */
    public ResourcefulProgressIndicator()
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            FX_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.progress.indicator", ex.getMessage(), ex);
        }
    }
