...
public class ResourcefulTreeView<T> extends TreeView<T> implements Resourceful, LocaleEventListener
{
     ...
     */
    public static <T> ResourcefulTreeView<T> create(Resource resource)
    {
        ResourcefulTreeView<T> treeView = new ResourcefulTreeView<>(resource);
        treeView.initialize();
        return treeView;
    }
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            FX_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.tree.view", ex.getMessage(), ex);
        }
    }
