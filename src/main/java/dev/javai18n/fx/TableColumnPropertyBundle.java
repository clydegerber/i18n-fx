...
/**
 * Provides a collection of localizable property values for a JavaFX {@link javafx.scene.control.TableColumn}.
 *
 * <p>TableColumn does not extend {@link javafx.scene.Node}, so this bundle does not extend
 * {@link NodePropertyBundle}. It provides header text and graphic properties directly.</p>
 */
public class TableColumnPropertyBundle implements AttributeCollection
{
    /** Creates a new TableColumnPropertyBundle. */
    public TableColumnPropertyBundle()
    {
    }

    /**
     * A key for the header text of the TableColumn.
     */
    public static final String TEXT = "Text";

    /**
     * A key for the graphic of the TableColumn (stored as a resolved {@link Image}).
     */
    ...
    /**
     * Returns the set of valid attribute names for a TableColumnPropertyBundle.
     *
     * @return The set of valid attribute names for a TableColumnPropertyBundle.
     */
