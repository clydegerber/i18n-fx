 ...
 */
public class ResourcefulRadioMenuItem extends RadioMenuItem implements Resourceful, LocaleEventListener
{
    static
    {
    ...
    /**
     * Construct a ResourcefulRadioMenuItem with the specified Resource.
     *
     * @param resource A Resource containing a MenuItemPropertyBundle.
     * @return A ResourcefulRadioMenuItem with updated Locale-specific values that is registered
     *         to listen to LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulRadioMenuItem create(Resource resource)
    {
        ResourcefulRadioMenuItem item = new ResourcefulRadioMenuItem(resource);
        item.initialize();
        return item;
    }
    ...
    /**
     * Constructs a RadioMenuItem bound to the given resource. Use {@link #create(Resource)}
     * for an initialized instance.
     * @param resource The resource identifying the locale source and bundle key.
     */
    protected ResourcefulRadioMenuItem(Resource resource)
    {
     ...
     */
    public ResourcefulRadioMenuItem()
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            FX_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.radio.menu.item", ex.getMessage(), ex);
        }
    }
