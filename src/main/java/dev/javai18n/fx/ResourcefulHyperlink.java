...
/**
 * A Hyperlink that supports localizing the name (id), style, text, graphic, tooltip,
 * accessible text, accessible help, and accessible role description.
 */
public class ResourcefulHyperlink extends Hyperlink implements Resourceful, LocaleEventListener
{
    static
    {
    ...
    /**
     * Construct a ResourcefulHyperlink with the specified Resource.
     * @param resource A Resource containing a ButtonBasePropertyBundle.
     * @return A ResourcefulHyperlink with updated Locale-specific values that is registered
     *         to listen to LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulHyperlink create(Resource resource)
    {
        ResourcefulHyperlink hyperlink = new ResourcefulHyperlink(resource);
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            FX_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.hyperlink", ex.getMessage(), ex);
        }
    }
