...
/**
 * A ToggleButton that supports localizing the name (id), style, text, graphic, tooltip,
 * accessible text, accessible help, and accessible role description.
 */
public class ResourcefulToggleButton extends ToggleButton implements Resourceful, LocaleEventListener
{
    static
    {
    ...
    /**
     * Construct a ResourcefulToggleButton with the specified Resource.
     * @param resource A Resource containing a ButtonBasePropertyBundle.
     * @return A ResourcefulToggleButton with updated Locale-specific values that is registered
     *         to listen to LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulToggleButton create(Resource resource)
    {
        ResourcefulToggleButton toggleButton = new ResourcefulToggleButton(resource);
    ...
    /**
     * Constructs a ToggleButton bound to the given resource. Use {@link #create(Resource)}
     * for an initialized instance.
     * @param resource The resource identifying the locale source and bundle key.
     */
    protected ResourcefulToggleButton(Resource resource)
    {
     ...
     */
    public ResourcefulToggleButton()
    {
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            FX_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.toggle.button", ex.getMessage(), ex);
        }
    }
