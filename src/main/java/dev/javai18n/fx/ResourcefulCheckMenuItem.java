 ...
 */
public class ResourcefulCheckMenuItem extends CheckMenuItem implements Resourceful, LocaleEventListener
{
    static
    {
     ...
     * @return A ResourcefulCheckMenuItem with updated Locale-specific values that is registered
     *         to listen to LocaleEvents generated from the specified Resource's source.
     */
    public static ResourcefulCheckMenuItem create(Resource resource)
    {
        ResourcefulCheckMenuItem item = new ResourcefulCheckMenuItem(resource);
        item.initialize();
        return item;
    }
    ...
    protected void updateLocaleSpecificValues()
    {
        ...
        {
            FX_LOGGER.log(System.Logger.Level.WARNING, "missing.resource.for.check.menu.item", ex.getMessage(), ex);
        }
    }
