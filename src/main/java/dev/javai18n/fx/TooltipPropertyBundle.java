...
/**
 * Provides a collection of localizable property values for a JavaFX {@link javafx.scene.control.Tooltip}.
 *
 * <p>Tooltip does not extend {@link javafx.scene.Node} in the standard sense for this purpose,
 * so this bundle does not extend {@link NodePropertyBundle}. It provides the tooltip text directly.</p>
 */
public class TooltipPropertyBundle implements AttributeCollection
{
    ...
    private static final Set<String> VALID_ATTRIBUTE_NAMES = Set.of(TEXT);
     ...
     *
     * @return The set of valid attribute names for a TooltipPropertyBundle.
     */
